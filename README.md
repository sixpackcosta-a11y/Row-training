...
## V112
- Añade **Ver resultados** en cada sesión MAR que tenga datos registrados.
- Muestra cada bloque o serie con tiempo, metros, ritmo /500, PPM, RPE y notas en una vista adaptada al móvil.
- **Comparar** continúa siendo una acción independiente para contrastar sesiones.
- Los resultados de Concept2/ErgData se asocian por equipo y fecha con la sesión ERGO planificada, aunque el remero no la haya abierto antes desde Row Training.
- En la ficha del remero aparece el nombre de la sesión planificada en lugar de `unplanned` cuando existe una sesión ERGO ese día.
- En los entrenamientos por intervalos o parciales de ErgData aparece **Ver parciales**, con tiempo, metros, ritmo /500, PPM, FC y descanso de cada serie disponible en Concept2.
- No requiere SQL.
